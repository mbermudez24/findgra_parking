		...
		<div class="row mb-4 mt-4">
			<div class="col-md-12">
				<button class="btn btn-primary btn-block btn-sm col-sm-2 float-right" type="button" id="new_location">
					<i class="fa fa-plus"></i> Crear reservacion
				</button>
			</div>
		</div>
		<div class="row">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-primary edit_location" type="button" data-id="<?php echo $row['id'] ?>" >Editar</button>
										<button class="btn btn-sm btn-outline-danger delete_location" type="button" data-id="<?php echo $row['id'] ?>">Eliminar</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	$('#new_location').click(function(){
		uni_modal("Nueva Ubicación de Vehículo","manage_location.php")
	})
