...
<div class="container-fluid mt-4">
	<div class="card">
		<div class="card-header">
			<span><b><?php echo isset($id) ? "Gestionar" : "Nueva" ?> Reserva</b></span>
		</div>
		<div class="card-body">
			<form action="" id="manage-vehicle"> 
				...
				<div class="col-lg-12">
					<div class="row form-group">
						<div class="col-md-5">
							...
							<select name="category_id" id="category_id" class="custom-select select2">
								<option value=""></option>
								<?php
									$category = $conn->query("SELECT * FROM category WHERE id = 5");
					...
					<div class="row form-group">
						<div class="col-md-5">
							<label for="" class="control-label">Nombre del Vehículo</label>
							<input type="text" class="form-control" name="vehicle_brand" value="<?php echo isset($vehicle_brand) ? $vehicle_brand : '' ?>">
						</div>
						<div class="col-md-5">
							<label for="" class="control-label">No del Registro del Vehículo</label>
					...
					<div class="row form-group">
						<div class="col-md-5">
							<label for="" class="control-label">Descripción del Vehículo</label>
					...
					<div class="row">
						<div class="col-md-12">
							<button class="btn btn-sm btn-primary btn-block col-sm-3 float-right">Guardar</button>
						</div>
					</div>
				</div>
			</form>
...
<script>
	$('#category_id').change(function(){
		...
		parent.append("<small><b><i>Tarifa: "+rate+"</i></b></small>")
